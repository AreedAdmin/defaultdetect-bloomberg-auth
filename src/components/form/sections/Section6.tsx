    ...
    <div className="min-h-screen bg-slate-950 p-8">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        `}</style>
          ...
          {/* EXT_SOURCE_2_missing - Rose Toggle */}
          <div
            className="group/input relative"
            onMouseEnter={() => setHoveredInput("EXT_SOURCE_2_missing")}
            onMouseLeave={() => setHoveredInput(null)}
          >
            <div className="flex items-center justify-between p-4 rounded-md transition-all duration-300 border-rose-400/30 hover:border-rose-400/50 hover:shadow-[0_0_20px_rgba(244,63,94,0.15)] bg-slate-900/50 border">
              <label
                htmlFor="EXT_SOURCE_2_missing"
                className="text-sm font-semibold text-rose-300 group-hover/input:text-rose-400 transition-all duration-300 cursor-pointer"
              >
                EXT SOURCE 2 Missing
              </label>
              <input
                ...
                className="w-12 h-6 appearance-none bg-slate-700 rounded-full relative cursor-pointer transition-colors duration-300 checked:bg-rose-500"
                style={{
                  boxShadow: formData.EXT_SOURCE_2_missing ? "0 0 10px rgba(244,63,94,0.5)" : "none",
                }}
              />
            </div>
            {hoveredInput === "EXT_SOURCE_2_missing" && (
              <div
                className="absolute inset-0 rounded-md pointer-events-none"
                style={{
          ...
          >
            ...
            <div className="relative mt-2">
              <input
                ...
                type="number"
                step="0.0001"
                placeholder="Enter EXT_SOURCE_3"
